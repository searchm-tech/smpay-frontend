...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden px-2 text-left text-sm outline-none ring-sidebar-ring transition-[width,height,padding] text-white bg-[#3C4D60] hover:bg-[#2c4257] hover:text-white focus-visible:ring-2 active:bg-[#2c4257] active:text-white disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-[#2c4257] data-[active=true]:font-medium data-[active=true]:text-white data-[state=open]:hover:bg-[#2c4257] data-[state=open]:hover:text-white group-data-[collapsible=icon]:!size-8 group-data-[collapsible=icon]:!p-2 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "text-white bg-[#3C4D60]",
        outline:
          "bg-[#3C4D60] text-white shadow-[0_0_0_1px_hsl(var(--sidebar-border))] hover:bg-[#2c4257] hover:text-white hover:shadow-[0_0_0_1px_hsl(var(--sidebar-accent))]",
      },
      size: {
        default: "h-[56px] text-sm",
        sm: "h-7 text-xs",
        lg: "h-12 text-sm group-data-[collapsible=icon]:!p-0",
      },
      isSelected: {
        true: "!bg-[#EB680E] !hover:bg-[#EB680E] !active:bg-[#EB680E] text-white",
      },
    },
    defaultVariants: {
      variant: "default",
...
>(({ className, ...props }, ref) => (
  <ul
    ...
    className={cn(
      "flex min-w-0 flex-col gap-1 border-sidebar-border",
      "group-data-[collapsible=icon]:hidden",
      className
    )}
    {...props}
...
>(({ asChild = false, size = "md", isActive, className, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      data-active={isActive}
      className={cn(
        "flex h-7 min-w-0 -translate-x-px items-center gap-2 overflow-hidden !rounded-none px-2 !text-white !bg-transparent outline-none ring-sidebar-ring hover:bg-sidebar-accent focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0 [&>svg]:text-sidebar-accent-foreground",
        size === "sm" && "text-xs",
        size === "md" && "text-sm",
        "group-data-[collapsible=icon]:hidden",
        className
