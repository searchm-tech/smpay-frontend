...
export const dialogContent = {
  private: (
    <div>
      <p>
        본 합의서는 주식회사 써치엠(이하 &quot;써치엠&quot;이라 한다)과
        제휴사(이하 &quot;제휴사&quot;라 한다)는 &quot;영업대행 업무
        계약서&quot;의 내용을 확대하여, SM Pay 솔루션(이하 &quot;SM Pay&quot;)
        이용과 이와 관련된 개인정보 수집 및 활용에 대하여 합의합니다.
      </p>
      <br />
      <p>제1조 (본 계약과의 관계)</p>
      <p>
  ...
  debit: (
    <div>
      <p>
        주식회사 써치엠(이하 &quot;써치엠&quot;)과 제휴사(이하
        &quot;제휴사&quot;)는 아래와 같이 광고비 자동이체 출금 서비스 이용에
        동의하며, 이에 따라 제휴사의 지정 계좌에서 자동으로 대금이 출금될 수
        있도록 승인합니다.
      </p>
      <br />
      <p>1. 출금 동의 내역</p>
